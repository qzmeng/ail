...
\frame{
  ...
  In Supervised learning, the machine learns based on examples and their
  already known classifications (training set)
  
  Based on the knowledge learnt from the examples, we can classify 
  unknown examples (test set)
}
...
\frame{
  ...
  & word_1 & word_2 & word_3 & word_4 & word_5 \\ \hline
  doc_1 & & & & & \\
  doc_2 & & & & & \\
  doc_3 & & & & & \\
